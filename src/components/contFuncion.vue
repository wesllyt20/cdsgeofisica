<template>
  <div>
    ...
    <v-timeline side="end" align="start">
      <v-timeline-item dot-color="#0075FF">
        ...
        <div class="d-flex">
          <div>
            <p class="parrafoFun ml-n2">
              <span class="pasos"> Paso 1 : </span> Ubicar el icono de capas
              <span>
                <svg
                  width="18px"
                  height="18px"
      ...
      <v-timeline-item dot-color="#0075FF">
        ...
        <div class="d-flex">
          <div>
            <p class="parrafoFun ml-n2">
              <span class="pasos"> Paso 2 : </span> Procedemos a activar el
              icono de check
              <span>
                <svg
                  width="18px"
      ...
      <v-timeline-item dot-color="#0075FF">
        ...
        <div class="d-flex">
          <div>
            <p class="parrafoFun ml-n2">
              <span class="pasos"> Paso 3 : </span> Luego, ubicaremos el icono
              de “Descripción y Leyenda”
              <span>
                <svg
                  width="18px"
                  height="18px"
