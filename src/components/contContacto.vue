<template>
  <div>
    <h2 id="tiCont">Contacto</h2>
    <div id="parCont" class="mb-5">
      <p class="parrafoCont">
      ...
      <ol class="subtiLista">
        ...
        <ul class="ulLista">
          ...
          >
            <g
              ...
              stroke-width="0"
              transform="translate(35.84,35.84), scale(0.86)"
            >
              <rect
                x="-194.56"
                y="-194.56"
        ...
        <ul class="ulLista">
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <path
                d="M23,0H9C4,0,0,4,0,9v14c0,5,4,9,9,9h14c5,0,9-4,9-9V9C32,4,28,0,23,0z M10,21c-2.8,0-5-2.2-5-5s2.2-5,5-5s5,2.2,5,5 S12.8,21,10,21z M22,21c-2.8,0-5-2.2-5-5s2.2-5,5-5s5,2.2,5,5S24.8,21,22,21z"
              ></path>
            </g>
          </svg>
          <a
